...
世間・日米株・暗号資産・AIのニュースを日本時間の毎朝7時に向けて更新する、スマートフォン対応のニュースサイトです。Google ニュースの日本語 RSS から直近48時間の記事を取得し、記事の見出しと出典を表示します。Gemini API の無料枠を設定すると、見出しを根拠に日本語の要点と優先順位を付けます。見出しだけでは確認できない事実を要約に補わない設計です。
